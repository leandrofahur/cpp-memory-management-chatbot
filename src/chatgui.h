...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // prevents memory leak even if constructor fails
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } // cppreference.com : method returns a pointer to the managed object
